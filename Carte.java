...
public class Carte 
{
	...
	public static String getPionJoueur() {
		return pionJoueur;
	}

	public void setPionJoueur(String pionJoueur) {
		Carte.pionJoueur = pionJoueur;
	}

	public static String getPionZombie() {
		return pionZombie;
	}

	public static void setPionZombie(String pionZombie) {
		Carte.pionZombie = pionZombie;
	}
